...
import bg.bobs.SevenZip.outStreamBLOB;
...
public class OutArchive {
    ...
    public void writeStartHeader(StartHeader h) throws IOException {
        ...
        //writeDirect(buf, 24);
        stream.setStartHeader(buf);
       // stream.applayStartHeader(buf);  
    }
    ...
    public void create(outStreamBLOB stream, boolean endMarker) throws IOException {
        this.stream = stream;
        writeSignature();
    }
